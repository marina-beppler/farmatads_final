<script lang="ts">
  import { IonButton, IonButtons, IonCard, IonContent, IonHeader, IonIcon, IonImg, IonInput, IonItem, IonLabel, IonPage, IonToolbar, toastController } from '@ionic/vue';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(() => {
        ...
        userId.value = xaropeConfig.userId || 0;
      });
